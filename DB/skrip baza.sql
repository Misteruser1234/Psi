...
ALTER TABLE `sadrzi` DROP FOREIGN KEY `R_12`; ALTER TABLE `sadrzi` ADD CONSTRAINT `R_12` FOREIGN KEY (`IDUO`) REFERENCES `uo`(`IDUO`) ON DELETE CASCADE ON UPDATE CASCADE;
