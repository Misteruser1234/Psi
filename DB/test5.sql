...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 01, 2019 at 04:28 PM
...
ALTER TABLE `jevlasnik`
  ...
  ADD CONSTRAINT `R_8` FOREIGN KEY (`IDUO`) REFERENCES `uo` (`IDUO`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `phae`
  ADD CONSTRAINT `R_2` FOREIGN KEY (`IDUO`) REFERENCES `uo` (`IDUO`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `sadrzi`
  ...
  ADD CONSTRAINT `R_12` FOREIGN KEY (`IDUO`) REFERENCES `uo` (`IDUO`) ON DELETE CASCADE ON UPDATE CASCADE;
