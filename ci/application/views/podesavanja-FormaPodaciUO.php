	...
	<form metod="post" name="UOform" >
		...
		<div class="my-5 py-2 row jumbotron pl-3">
			...
			<div class="col-sm-8">
				...
				<div class="form-check form-check-inline">
					<input class="form-check-input" type="checkbox" id="kafic" name="kafic" value="2">
					<label class="form-check-label" for="kafic">Kafic</label>
				</div>
				<div class="form-check form-check-inline">
					<input class="form-check-input" type="checkbox" id="brza-hrana"  name="brza" value="3">
				...
				<div class="row jumbotron">
					<div class="col-lg-3 col-md-6 my-3">
						...
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s1v1" name="craft">
							<label class="form-check-label" for="s1v1">Craft pivo</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s1v2" name="kafaspec">
							<label class="form-check-label" for="s1v2">Kafa special</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s1v3" name="zestina">
							<label class="form-check-label" for="s1v3">Zestina</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s1v4" name="vina">
							<label class="form-check-label" for="s1v4">Vina</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s1v5" name="kokteli">
							<label class="form-check-label" for="s1v5">Kokteli</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s1v6" name="vitaminski">
							<label class="form-check-label" for="s1v6">Vitaminski napici</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s1v7" name="likeri">
							<label class="form-check-label" for="s1v7">Likeri</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s1v8" name="bezalkoholna">
					...
					<div class="col-lg-3 col-md-6 my-3">
						...
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s2v1" name="kuvana">
							<label class="form-check-label" for="s1v1">Kuvana jela</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s2v2" name="dnevni">
							<label class="form-check-label" for="s1v2">Dnevni meni</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s2v3" name="rostilj">
							<label class="form-check-label" for="s1v3">Rostilj</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s2v4" name="pizza">
							<label class="form-check-label" for="s1v4">Pizza</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s2v5" name="salate">
							<label class="form-check-label" for="s1v5">Obrok salate</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s2v6" name="pecenje">
							<label class="form-check-label" for="s1v6">Pecenje</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s2v7" name="sushi">
							<label class="form-check-label" for="s1v7">Sushi</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s2v8" name="sendvici">
					...
					<div class="col-lg-3 col-md-6 my-3">
						...
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s3v1" name="basta">
							<label class="form-check-label" for="s1v1">Basta</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s3v2" name="pogled">
							<label class="form-check-label" for="s1v2">Pogled</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s3v3" name="reka">
							<label class="form-check-label" for="s1v3">Reka</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s3v4" name="centar">
							<label class="form-check-label" for="s1v4">Centar</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s3v5" name="balkon">
							<label class="form-check-label" for="s1v5">Balkon</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s3v6" name="svirka">
							<label class="form-check-label" for="s1v6">Ziva svirka</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s3v7" name="chill">
							<label class="form-check-label" for="s1v7">Chill</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s3v8" name="splav">
					...
					<div class="col-lg-3 col-md-6 my-3">
						...
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s4v1" name="wifi">
							<label class="form-check-label" for="s1v1">WiFi</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s4v2" name="pet">
							<label class="form-check-label" for="s1v2">Pet Frendly</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s4v3" name="parking">
							<label class="form-check-label" for="s1v3">Parking</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s4v4" name="baby">
							<label class="form-check-label" for="s1v4">Baby oprema</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s4v5" name="nosmoking">
							<label class="form-check-label" for="s1v5">No Smoking zona</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s4v6" name="dostava">
							<label class="form-check-label" for="s1v6">Dostava</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s4v7" name="happy">
							<label class="form-check-label" for="s1v7">Happy hour</label>
						</div>
						<div class="form-check np-polje">
							<input type="checkbox" class="form-check-input" id="s4v8" name="tv">
		...
		<div class="pt-5 pb-2">
				...
				<textarea class="w-100 ml-3" name="opis" id="opis" rows="10" name="opis"></textarea>
		</div>

		<!-- IZDVAJAMO SA MENIA -->
		<div class="pt-5 pb-2">
			<div class="h5 mb-3">Izdvajamo sa menia:</div>
			<textarea class="w-100 ml-3" name="info1" id="info1" rows="10" name="samenija"></textarea>
		</div>

		<!-- PO CEMU SE RAZLIKUJEMO OD DRUGIH -->
		<div class="pt-5 pb-2">
				<div class="h5 mb-3">Po cemu se razlikujemo od drugih:</div>
				<textarea class="w-100 ml-3" name="info2" id="info2" rows="10" name="razlike"></textarea>
		</div>

		<!-- ZASTO TREBA DA DODJETE KOD NAS -->
		<div class="pt-5 pb-2">
			<div class="h5 mb-3">Zasto treba da dodjete kod nas:</div>
			<textarea class="w-100 ml-3" name="info3" id="info3" rows="10" name="zasto"></textarea>
		</div>

		<div class="row py-5">
			<div class="col-md-6">
					<button class="btn btn-primary w-100 my-3 py-3" href=" <?php echo site_url('Vlasnik/ubaciUO'); ?> ">
