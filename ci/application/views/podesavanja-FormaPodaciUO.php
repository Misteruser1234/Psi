		...
		<div class="py-2">
			...
			<div class="row">
				<div class="col-md-4 mb-4">
					<div class="row">
						<div class="col-sm-12">
							<img class= "img-fluid" src=" <?php if($data['id']==NULL) echo base_url('img/restoran.jpg'); else { if($slika[0]!=NULL) echo base_url('img/uo/'.$slika[0]); else echo base_url('img/restoran.jpg'); };?>" alt="" id="slika1">
						</div>
						<div class="col-sm-12">
				...
				<div class="col-md-4 mb-4">
					<div class="row">
						<div class="col-sm-12">
							<img class= "img-fluid" src=" <?php if($data['id']==NULL) echo base_url('img/restoran.jpg'); else { if($slika[1]!=NULL) echo base_url('img/uo/'.$slika[1]); else echo base_url('img/restoran.jpg');  };?>" alt="" id="slika2">
						</div>
						<div class="col-sm-12">
				...
				<div class="col-md-4 mb-4">
					<div class="row">
						<div class="col-sm-12">
							<img class= "img-fluid" src=" <?php if($data['id']==NULL) echo base_url('img/restoran.jpg'); else { if($slika[2]!=NULL) echo base_url('img/uo/'.$slika[2]); else echo base_url('img/restoran.jpg');  };?> " alt="" id="slika3">
						</div>
						<div class="col-sm-12">
			...
			<div class="row">
				<div class="col-md-4 mb-4">
					<div class="row">
						<div class="col-sm-12">
							<img class= "img-fluid" src="  <?php if($data['id']==NULL) echo base_url('img/restoran.jpg'); else { if($slika[03]!=NULL) echo base_url('img/uo/'.$slika[3]); else echo base_url('img/restoran.jpg');  };?>" alt="" id="slika4">
						</div>
						<div class="col-sm-12">
				...
				<div class="col-md-4 mb-4">
					<div class="row">
						<div class="col-sm-12">
							<img class= "img-fluid" src=" <?php if($data['id']==NULL) echo base_url('img/restoran.jpg'); else { if($slika[4]!=NULL) echo base_url('img/uo/'.$slika[4]); else echo base_url('img/restoran.jpg');  };?>" alt="" id="slika5">
						</div>
						<div class="col-sm-12">
				...
				<div class="col-md-4 mb-4">
					<div class="row">
						<div class="col-sm-12">
							<img class= "img-fluid" src=" <?php if($data['id']==NULL) echo base_url('img/restoran.jpg'); else { if($slika[5]!=NULL) echo base_url('img/uo/'.$slika[5]); else echo base_url('img/restoran.jpg');  };?>" alt="" id="slika6">
						</div>
						<div class="col-sm-12">
			...
			<div class="row">
				<div class="col-md-4 mb-4">
					<div class="row">
						<div class="col-sm-12">
							<img class= "img-fluid" src=" <?php if($data['id']==NULL) echo base_url('img/restoran.jpg'); else { if($slika[6]!=NULL) echo base_url('img/uo/'.$slika[6]); else echo base_url('img/restoran.jpg');  };?>" alt="" id="slika7">
						</div>
						<div class="col-sm-12">
				...
				<div class="col-md-4 mb-4">
					<div class="row">
						<div class="col-sm-12">
							<img class= "img-fluid" src=" <?php if($data['id']==NULL) echo base_url('img/restoran.jpg'); else { if($slika[7]!=NULL) echo base_url('img/uo/'.$slika[7]); else echo base_url('img/restoran.jpg');  };?>" alt="" id="slika8">
						</div>
						<div class="col-sm-12">
				...
				<div class="col-md-4 mb-4">
					<div class="row">
						<div class="col-sm-12">
							<img class= "img-fluid" src=" <?php if($data['id']==NULL) echo base_url('img/restoran.jpg'); else { if($slika[8]!=NULL) echo base_url('img/uo/'.$slika[8]); else echo base_url('img/restoran.jpg');  };?>" alt="" id="slika9">
						</div>
						<div class="col-sm-12">
